...
- 🌐 Desarrollo **web** del ecosistema Kiubo
- 💬 Integración con sistemas de **mensajería en tiempo real** (WebSocket · JWT)
- 🧩 Colaboro con el equipo multiplataforma (**Kotlin Multiplatform**)
- 📲 Programo desde el móvil con **Termux**
- 🎵 Fuera del código: produzco música
